...
var fa = /* @__PURE__ */ K("<article><span class=\"overview-value\"> </span> <span class=\"overview-label\"> </span></article>");
function pa(e, t) {
	Ge(t, !1);
...
var ma = /* @__PURE__ */ K("<span class=\"developer-expand-hint\">展開作法與方向</span>"), ha = /* @__PURE__ */ K("<span class=\"developer-next-label\">Next Step :</span> <span class=\"developer-next-action\"> </span> <!>", 1), ga = /* @__PURE__ */ K("<li> </li>"), _a = /* @__PURE__ */ K("<section class=\"detail-section next-steps\"><h4 class=\"detail-heading\">後續動作</h4> <ul class=\"detail-list\"></ul></section>"), va = /* @__PURE__ */ K("<section class=\"detail-section blockers\"><h4 class=\"detail-heading\">Blockers</h4> <ul class=\"detail-list\"></ul></section>"), ya = /* @__PURE__ */ K("<code class=\"reference\"> </code>"), ba = /* @__PURE__ */ K("<article class=\"decision-item\"><p> </p> <!></article>"), xa = /* @__PURE__ */ K("<section class=\"detail-section\"><h4 class=\"detail-heading\">Decisions</h4> <div class=\"decision-list\"></div></section>"), Sa = /* @__PURE__ */ K("<p> </p>"), Ca = /* @__PURE__ */ K("<article class=\"route-item\"><div class=\"route-heading\"><strong> </strong> <span> </span></div> <!></article>"), wa = /* @__PURE__ */ K("<section class=\"detail-section\"><h4 class=\"detail-heading\">Routes</h4> <div class=\"route-list\"></div></section>"), Ta = /* @__PURE__ */ K("<div class=\"path-list\"></div>"), Ea = /* @__PURE__ */ K("<section class=\"detail-section claim-section\"><h4 class=\"detail-heading\">Claim</h4> <p> </p> <!> <!></section>"), Da = /* @__PURE__ */ K("<div class=\"developer-body\"><h4 class=\"developer-body-title\">作法與方向</h4> <!> <!> <!> <!> <!></div>"), Oa = /* @__PURE__ */ K("<!> <!>", 1);
function ka(e, t) {
	Ge(t, !1);
...
var ja = /* @__PURE__ */ K("<option> </option>"), Ma = /* @__PURE__ */ K("<select class=\"inline-priority-select\"></select>"), Na = /* @__PURE__ */ K("<span> </span>"), Pa = /* @__PURE__ */ K("<span class=\"item-row-priority\"><!></span>"), Fa = /* @__PURE__ */ K("<input class=\"inline-edit-input\" maxlength=\"500\"/>"), Ia = /* @__PURE__ */ K("<span class=\"spike-item-title\"> </span>"), La = /* @__PURE__ */ K("<select class=\"inline-status-select\"><option>待處理</option><option>已完成</option></select>"), Ra = /* @__PURE__ */ K("<span class=\"item-row-action\"><button class=\"inline-delete-button\" type=\"button\">刪除</button></span>"), za = /* @__PURE__ */ K("<li><span aria-hidden=\"true\"> </span> <!> <span class=\"item-row-description\"><!></span> <span class=\"item-row-utility-panel\"><span class=\"item-row-modules\"><!></span> <span class=\"item-row-status\"><!></span> <!></span></li>");
function Ba(e, t) {
	Ge(t, !1);
...
var Va = /* @__PURE__ */ K("<option> </option>"), Ha = /* @__PURE__ */ K("<select class=\"inline-status-select\"></select> <select class=\"inline-priority-select\"></select>", 1), Ua = /* @__PURE__ */ K("<span> </span>"), Wa = /* @__PURE__ */ K("<input class=\"task-title-input\" aria-label=\"任務名稱\" maxlength=\"160\"/>"), Ga = /* @__PURE__ */ K("<h3> </h3>"), Ka = /* @__PURE__ */ K("<textarea class=\"task-summary-input\" aria-label=\"任務描述\" maxlength=\"1000\" rows=\"3\"></textarea>"), qa = /* @__PURE__ */ K("<p class=\"task-summary\"> </p>"), Ja = /* @__PURE__ */ K("<section><h4 class=\"detail-heading\"> </h4> <ul class=\"detail-list\"></ul></section>"), Ya = /* @__PURE__ */ K("<div class=\"spike-add-form\"><input aria-label=\"新增子項目描述\" placeholder=\"新增待處理項目\" maxlength=\"500\"/> <select aria-label=\"新增子項目優先級\"></select> <button type=\"button\">新增</button> <button type=\"button\">取消</button> <p class=\"spike-field-error\" role=\"alert\"> </p></div>"), Xa = /* @__PURE__ */ K("<button class=\"spike-add-button\" type=\"button\">＋</button>"), Za = /* @__PURE__ */ K("<div class=\"spike-add-shell\"><!></div>"), Qa = /* @__PURE__ */ K("<article><header class=\"task-header\"><div class=\"task-title-group\"><div class=\"time-task-status-line\"><span> </span> <!></div> <div class=\"time-task-title-line\"><!> <span class=\"task-duration\"> </span></div></div> <div class=\"task-header-meta\"><strong class=\"task-fraction\"> </strong> <code class=\"task-id\"> </code></div></header> <!> <!> <div class=\"work-columns\"><!> <section class=\"task-adder-section\"><!></section></div></article>");
function $a(e, t) {
	Ge(t, !1);
	...
	var E = Qa(), te = F(E), ne = F(te), D = F(ne), re = F(D), ie = F(re, !0);
	A(re);
	var ae = L(re, 2), oe = (e) => {
		var t = Ha(), n = I(t);
...
var eo = /* @__PURE__ */ K("<p class=\"empty-state\"> </p>");
function to(e, t) {
	Ge(t, !1);
...
var io = /^#[0-9a-f]{6}$/i;
function ao(e) {
	return typeof e == "string" && io.test(e);
}
function oo(e = "light", t = {}) {
	let n = e === "dark" ? "dark" : "light", r = ro[n], i = { base: n };
	for (let e of no) {
		let n = t[e.key];
		i[e.key] = ao(n) ? n.toLowerCase() : r[e.key];
	}
	return i;
}
function so(e) {
...
function co(e, t) {
	...
	let n = (e) => {
		let t = e.slice(1), n = [
			...
			2,
			4
		].map((e) => so(Number.parseInt(t.slice(e, e + 2), 16)));
...
function mo(e, t) {
	...
	], d = /^#[0-9a-f]{6}$/i, f = /* @__PURE__ */ N(), p = /* @__PURE__ */ N([]), m = /* @__PURE__ */ N(a()), h = /* @__PURE__ */ N(o()?.base ?? s()), g = /* @__PURE__ */ N(v(oo(H(h)))), _ = /* @__PURE__ */ N({ ...H(g) });
	function v(e) {
		return Object.fromEntries(no.map((t) => [t.key, e[t.key]]));
	}
	function y(e) {
	...
	function x() {
		y(o() ? oo(o().base, o()) : oo(s())), typeof H(f).showModal == "function" ? H(f).showModal() : H(f).setAttribute("open", "");
	}
	function S() {
		H(f).open && H(f).close();
	}
	function C(e) {
		y(oo(e.currentTarget.value));
	}
	function w(e, t, n) {
	...
	li(ce), A(se);
	var fe = L(se, 2);
	X(fe, 7, () => no, (e) => e.key, (e, t, r) => {
		var i = fo(), a = F(i), o = F(a, !0);
		A(a);
		var s = L(a, 2), c = F(s);
		gi(c);
		var l = L(c, 2);
	...
	}), G("change", re, b), ui(re, () => H(m), (e) => P(m, e)), Cr("cancel", ie, E), G("click", oe, ee), G("change", ce, C), G("click", _e, () => y(oo(H(h)))), G("click", ve, ee), G("click", ye, te), q(e, ne), Ke();
}
wr([
	"change",
	"click",
...
function Co(e, t) {
	...
	var p = So(), m = L(F(p), 2), h = F(m), g = L(F(h), 2), _ = F(g);
	gi(_), Ie(2), A(g), A(h);
...
var wo = (e, t = g, n = g) => {
	...
	var n = Io();
	Eo(L(F(n), 2), t), A(n), q(e, n);
}, Oo = (e, t = g, n = g) => {
	var r = Lo(), i = F(r), a = F(i, !0);
	A(i);
	var o = L(i, 2), s = F(o), c = F(s);
	wo(c, () => (t(), U(() => t().engineeringLane.source)), () => ""), wo(L(c, 4), () => (t(), U(() => t().engineeringLane.result)), () => "time-evaluation-result"), A(s);
	var l = L(s, 2), u = F(l);
	wo(u, () => (t(), U(() => t().capacityLane.source)), () => ""), wo(L(u, 4), () => (t(), U(() => t().capacityLane.result)), () => "time-evaluation-result"), A(l), A(o);
	var d = L(o, 2);
	wo(L(F(d), 2), () => (t(), U(() => t().merge)), () => (t(), U(() => t().merge.className))), A(d);
	var f = L(d, 2), p = F(f);
	wo(p, () => (t(), U(() => t().risk.trend)), () => ""), wo(L(p, 4), () => (t(), U(() => t().risk.result)), () => (t(), U(() => t().risk.result.className))), A(f);
	var m = L(f, 2), h = F(m, !0);
	A(m), A(r), z(() => {
	...
	A(p), A(f), Do(L(f, 2), () => (t(), U(() => t().composition))), A(r), z(() => {
	...
	A(s), A(o), Do(L(o, 2), () => (t(), U(() => t().composition))), A(n), z(() => {
		J(i, (t(), U(() => t().intro))), J(c, (t(), U(() => t().calibrationText)));
	}), q(e, n);
}, jo = /* @__PURE__ */ K("<div><span> </span> <strong> </strong> <small> </small></div>"), Mo = /* @__PURE__ */ K("<div class=\"time-metric\"><span> </span><strong> </strong></div>"), No = /* @__PURE__ */ K("<div class=\"time-metric-grid\"></div>"), Po = /* @__PURE__ */ K("<div class=\"time-source-row\"><div><strong> </strong><p> </p></div> <span> </span></div>"), Fo = /* @__PURE__ */ K("<div class=\"time-source-list\"></div>"), Io = /* @__PURE__ */ K("<section class=\"time-composition\"><h3>估算組成</h3> <!></section>"), Lo = /* @__PURE__ */ K("<section class=\"time-tab-panel time-flow-panel\" id=\"time-flow-panel\" role=\"tabpanel\" aria-labelledby=\"time-flow-tab\"><p class=\"time-flow-intro\"> </p> <div class=\"time-flow-lanes\"><section class=\"time-flow-lane\" aria-label=\"工程估算路徑\"><!> <span class=\"time-flow-arrow\">→</span> <!></section> <section class=\"time-flow-lane\" aria-label=\"工作容量路徑\"><!> <span class=\"time-flow-arrow\">→</span> <!></section></div> <div class=\"time-flow-merge\"><span class=\"time-flow-arrow\">↓</span> <!></div> <div class=\"time-flow-lane time-flow-risk\"><!> <span class=\"time-flow-arrow\">→</span> <!></div> <p class=\"time-flow-note\"> </p></section>"), Ro = /* @__PURE__ */ K("<section class=\"time-tab-panel\" id=\"time-engineering-panel\" role=\"tabpanel\" aria-labelledby=\"time-engineering-tab\"><!> <section class=\"time-explanation-card\"><h3 class=\"time-formula-heading\"><span aria-hidden=\"true\"></span> 風險評估公式</h3> <p> </p> <code class=\"time-formula\"> </code></section> <section class=\"time-explanation-card\"><h3>執行校準</h3> <p> </p></section> <!></section>"), zo = /* @__PURE__ */ K("<p class=\"time-empty-note\">目前沒有休假或其他容量例外。</p>"), Bo = /* @__PURE__ */ K("<section class=\"time-tab-panel\" id=\"time-capacity-panel\" role=\"tabpanel\" aria-labelledby=\"time-capacity-tab\"><!> <div class=\"time-capacity-toolbar\"><p>工作容量由每日分配、工作日及休假例外共同產生。</p></div> <!> <section class=\"time-explanation-card\"><h3>每日容量公式</h3> <p>固定不可工作時間只在產生容量時間線時扣除一次；週末依工作日設定排除。</p> <code class=\"time-formula\"> </code></section> <section class=\"time-composition\"><h3> </h3> <div class=\"time-source-list\"><!></div></section></section>"), Vo = /* @__PURE__ */ K("<section class=\"time-tab-panel time-estimate-only-panel\"><p class=\"time-flow-intro\"> </p> <!> <section class=\"time-explanation-card\"><h3>執行校準</h3> <p> </p></section> <!></section>"), Ho = /* @__PURE__ */ K("<span> </span>"), Uo = /* @__PURE__ */ K("<section class=\"time-estimate-readout\"><div class=\"time-estimate-meta\"><span>預估工時</span> <!></div> <strong> </strong></section> <section class=\"time-explanation-card time-item-rationale\"><h3>估算依據</h3> <p> </p></section>", 1), Wo = /* @__PURE__ */ K("<div class=\"time-source-row\"><div><strong> </strong> <p> </p></div> <span> </span></div>"), Go = /* @__PURE__ */ K("<section class=\"time-explanation-card\"><h3>固定公式</h3> <code class=\"time-formula\"> </code></section>"), Ko = /* @__PURE__ */ K("<code class=\"time-reference\"> </code>"), qo = /* @__PURE__ */ K("<div><div class=\"time-detail-toolbar\"><span> </span> <button class=\"time-small-button\" type=\"button\"> </button></div> <!> <section class=\"time-item-technical\"><!> <!> <!> <!></section></div>"), Jo = /* @__PURE__ */ K("<span aria-hidden=\"true\"></span>"), Yo = /* @__PURE__ */ K("<div class=\"time-report-field\"><span> </span> <strong><!> </strong></div>"), Xo = /* @__PURE__ */ K("<button class=\"time-tab\" type=\"button\" role=\"tab\"> </button>"), Zo = /* @__PURE__ */ K("<div class=\"time-tab-list\" role=\"tablist\" aria-label=\"進度報告詳細資訊\"></div> <!> <!> <!>", 1), Qo = /* @__PURE__ */ K("<div><div class=\"time-detail-toolbar\"><span class=\"time-report-caption\"> </span> <button class=\"time-small-button\" type=\"button\"> </button></div> <section class=\"time-report-overview\"><div class=\"time-report-grid\"></div> <p class=\"time-report-updated\"> </p></section> <section class=\"time-project-details\"><!></section></div>"), $o = /* @__PURE__ */ K("<dialog class=\"theme-dialog time-dialog\" id=\"time-dialog\" aria-labelledby=\"time-dialog-title\"><div class=\"theme-dialog-heading\"><div><p class=\"section-kicker\"> </p> <h2 id=\"time-dialog-title\"> </h2></div> <button class=\"theme-close\" type=\"button\"><span aria-hidden=\"true\">×</span></button></div> <div class=\"time-dialog-content\"><!></div></dialog>");
function es(e, t) {
	Ge(t, !1);
	let n = (e, t = g, n = g) => {
		var r = Bo(), i = F(r), a = (e) => {
	...
	var ee = jr(), E = I(ee), te = (e) => {
		var t = $o(), r = F(t), l = F(r), f = F(l), g = F(f, !0);
		A(f);
		var y = L(f, 2), b = F(y, !0);
		A(y), A(l);
		var ee = L(l, 2);
		...
		var E = L(r, 2), te = F(E), ne = (e) => {
			...
			var h = L(l, 2), g = F(h), _ = (e) => {
				...
				var i = L(r, 2);
				Oo(i, () => (W(s()), U(() => s().flow)), () => (W(s()), U(() => s().activeTab === "flow")));
				var a = L(i, 2);
				ko(a, () => (W(s()), U(() => s().engineering)), () => (W(s()), U(() => s().activeTab === "engineering")));
				var o = L(a, 2);
				n(o, () => (W(s()), U(() => s().capacity)), () => (W(s()), U(() => s().activeTab === "capacity"))), q(e, t);
			}, y = (e) => {
				Ao(e, () => (W(s()), U(() => s().estimateOnly)));
			};
			Y(g, (e) => {
...
function ss(e, t) {
	...
	var ne = os(), D = F(ne), re = L(F(D), 6), ie = F(re);
	A(re), A(D);
...
var cs = /* @__PURE__ */ K("<span class=\"time-risk-dot\"></span>"), ls = /* @__PURE__ */ K("<span class=\"time-chevron\">›</span>"), us = /* @__PURE__ */ K("<button type=\"button\"><span> </span> <!> <!></button>");
function ds(e, t) {
